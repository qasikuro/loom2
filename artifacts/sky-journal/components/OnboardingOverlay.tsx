...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    subtitle:    'journal',
    description: 'Write diary entries, capture moments with photos, and log time with friends. Every entry stays completely private — just for you.',
  ...
  },
  {
    ...
    subtitle:    'create',
    description: 'Build manga-style chapters with photos and captions. Tap the ✦ Create button to begin — share with the world or keep it private.',
    gradient:    ['#14083A', '#3C1870', '#220E48'],
    accent:      '#D0B4FF',
    hint:        'Tap the ✦ centre button →',
  },
  {
    id:          'discover',
    emoji:       '🪄',
    ...
    subtitle:    'discover',
    description: 'Explore chapters from other sky children. Browse by mood — Lonely, Dreamy, Chaotic, Hopeful. Follow creators and witness their stories.',
  ...
  },
  {
    ...
    emoji:       '💌',
    title:       'Vibe Stickers',
    subtitle:    'send a vibe',
    description: 'Tap ✦ on any story card to send an animated vibe sticker — ☀️ Hopeful, 🌪️ Chaotic, 💕 Romantic and more. Each sticker plays its own playful sound.',
    gradient:    ['#1A0830', '#3A1058', '#240C40'],
    accent:      '#E8A8D0',
    hint:        'Tap ✦ on any story in Discover →',
  },
  {
    id:          'drift',
    emoji:       '🌙',
    ...
    subtitle:    'drift mode',
    description: 'When the world feels heavy, drift with Lumi. Guided focus sessions, breathing exercises, and star-lit calm — any time you need it.',
  ...
  },
  {
    ...
    subtitle:    'profile & sounds',
    description: 'Shape your character, log outfits, and choose what the world sees. Toggle animation sounds on or off anytime in Profile → Settings.',
    gradient:    ['#160824', '#3A1250', '#200C38'],
    accent:      '#E8B0F8',
    hint:        'Profile tab → tap ⚙ Settings →',
  },
];
