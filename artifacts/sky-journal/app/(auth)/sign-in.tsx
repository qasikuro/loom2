...
const styles = StyleSheet.create({
  ...
  appName: { fontSize: 13, fontFamily: 'Satoshi-Bold', letterSpacing: 3, color: '#C8A84B', textAlign: 'center', marginBottom: 10, textTransform: 'uppercase' },
  title: { fontSize: 28, fontFamily: 'Satoshi-Bold', color: '#F0ECFF', textAlign: 'center', letterSpacing: -0.5, marginBottom: 8 },
  subtitle: { fontSize: 14, fontFamily: 'Satoshi-Regular', color: 'rgba(200,184,232,0.65)', textAlign: 'center', marginBottom: 36, lineHeight: 20 },
  form: { gap: 18 },
  field: { gap: 8 },
