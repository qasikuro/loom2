...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 15, fontFamily: 'Inter_600SemiBold', color: 'rgba(200,184,232,0.9)' },
  ...
  privatePillText: { fontSize: 10, fontFamily: 'Inter_500Medium', color: 'rgba(200,184,232,0.7)' },
  ...
  promptText: { flex: 1, fontSize: 13, fontFamily: 'Inter_400Regular', fontStyle: 'italic', color: 'rgba(200,184,232,0.55)', lineHeight: 19 },
  textArea: {
    borderWidth: 1, borderRadius: 16, padding: 18,
    fontSize: 17, fontFamily: 'Inter_400Regular', lineHeight: 28, minHeight: 180,
    fontStyle: 'italic', marginBottom: 6,
    color: 'rgba(240,234,248,0.9)',
    borderColor: 'rgba(200,184,232,0.18)',
    backgroundColor: 'rgba(255,255,255,0.04)',
  },
  charCount: { fontSize: 11, fontFamily: 'Inter_400Regular', color: 'rgba(200,184,232,0.3)', textAlign: 'right', marginBottom: 18 },
  moodLabel: { fontSize: 11, fontFamily: 'Inter_500Medium', color: 'rgba(200,184,232,0.45)', letterSpacing: 0.5, textTransform: 'uppercase', marginBottom: 10 },
