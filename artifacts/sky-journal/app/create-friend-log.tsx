...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 11, fontFamily: 'Inter_500Medium', letterSpacing: 0.4, textTransform: 'uppercase', marginBottom: 8 },
  ...
  nameAvatarText: { fontSize: 16, fontFamily: 'Inter_600SemiBold' },
  ...
  suggAvatarText: { fontSize: 13, fontFamily: 'Inter_600SemiBold' },
  suggName: { flex: 1, fontSize: 14, fontFamily: 'Inter_500Medium' },
  suggCount: { fontSize: 11, fontFamily: 'Inter_400Regular' },
  metBadge: { flexDirection: 'row', alignItems: 'center', gap: 8, borderWidth: 1, borderRadius: 12, padding: 12, marginTop: 8 },
  metBadgeText: { flex: 1, fontSize: 13, fontFamily: 'Inter_400Regular' },
  noteInput: { borderWidth: 1, borderRadius: 14, padding: 14, fontSize: 15, fontFamily: 'Inter_400Regular', lineHeight: 24, minHeight: 110, fontStyle: 'italic', marginBottom: 4 },
